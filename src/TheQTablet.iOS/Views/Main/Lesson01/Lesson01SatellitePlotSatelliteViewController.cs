...
namespace TheQTablet.iOS.Views.Main.Lesson01
{
    ...
    public class Lesson01SatellitePlotSatelliteViewController : BaseViewController<SatellitePlotViewModel>, IUIAdaptivePresentationControllerDelegate
    { 
        public Lesson01SatellitePlotSatelliteViewController()
        {
        }
        ...
        private KnobContainerView _satelliteAngleKnob;
        ...
        protected override void CreateView()
        {
            ...
            _satelliteAngleKnob = new KnobContainerView("SATELLITE LENS")
            {
                TranslatesAutoresizingMaskIntoConstraints = false,
                Step = ViewModel.Step,
            };
            View.AddSubview(_satelliteAngleKnob);
        ...
        protected override void LayoutView()
        {
            ...
            _satelliteAngleKnob.WidthAnchor.ConstraintEqualTo(View.WidthAnchor, 0.22f).Active = true;
            _satelliteAngleKnob.TopAnchor.ConstraintEqualTo(_sceneViewBorder.TopAnchor).Active = true;
            _satelliteAngleKnob.BottomAnchor.ConstraintEqualTo(View.BottomAnchor).Active = true;
            _satelliteAngleKnob.LeftAnchor.ConstraintEqualTo(_telescopeAngleKnob.RightAnchor, 5).Active = true;
        ...
        protected override void BindView()
        {
            ...
            set.Bind(_telescopeAngleKnob.KnobControl).For(v => v.SteppedAngle).To(vm => vm.SatelliteAngle);
